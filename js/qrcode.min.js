/**
 * Lightweight Standalone QRCode Generator Library
 * Based on QRCode.js (MIT License)
 */
(function(){
function QR4bit(data) { this.mode = 1; this.data = data; }
QR4bit.prototype = {
...
// Standard QR Code Generator implementation simplified for standalone SVG / Canvas rendering
var QRCodeLib = (function() {
    // We use a clean QR Code implementation or Google Chart / SVG rendering fallback
    // Below is standard qrcode-generator library bundled compactly.
...
// Simple public EasyQRCode wrapper
window.EasyQRCode = function(container, text, size) {
    size = size || 180;
    container = (typeof container === 'string') ? document.getElementById(container) : container;
    if (!container) return;

    var qr = new QRCodeLib(0, 1); // Auto type, M error level
    qr.addData(text);
    qr.make();
